...
public class MyPostFromTextFile {
	...
	public void user_hit_the_post_request_with_json_data() throws IOException{
		...
		//File file = new File("C:\\Users\\Rashmi\\workspace\\RestCucumberProj\\src\\test\\java\\com\\basic\\postUpdatedJsonSD\\user.json");
	    File file=new File("/src/test/java/com/basic/postFromTextFileSD");
	    //String content = null;
